...
static CECXBMCKeymap_ CECXBMCKeymap[] = {
    ...
    { CEC_User_Control_Enter                   , "enter"     },
    { CEC_User_Control_Clear                   , "clear"     },
    ...
    { CEC_User_Control_Power                   , "power"     },
    { CEC_User_Control_VolumeUp                , "volumeplus"},
    { CEC_User_Control_VolumeDown              , "volumeminus"},
    { CEC_User_Control_Mute                    , "mute"      },
    ...
    { CEC_User_Control_PausePlayFunction       , "pause"     },
    { CEC_User_Control_RecordFunction          , "record"    },
    { CEC_User_Control_PauseRecordFunction     , NULL        },
    { CEC_User_Control_StopFunction            , "stop"      },
    { CEC_User_Control_MuteFunction            , "mute"      },
